...
knitr::include_graphics(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/practicals/images/artificial_neuron.png"))
```
...
pROC::roc( 
  response = 
    ru_dwellings_data_testing %>% dplyr::pull(rural_urban),
  predictor =
    ru_dwellings_nnet_predicted_categories[, 1], 
  plot=TRUE,  grid=TRUE, print.auc=TRUE
  )
```
