...
The first component alone explains `r summary(penguins_pca)$importance[3, 1] %>% round(digits = 2)`% of variance, and the first two together explain `r summary(penguins_pca)$importance[3, 2] %>% round(digits = 2)`% of variance
