...
leicester_2011OAC <- read_csv("~/Repos/granolarr/Data/2011_OAC_Raw_uVariables_Leicester.csv")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Load Indexes of Multiple deprivation data
leicester_IMD2015 <- read_csv("~/Repos/granolarr/Data/IndexesMultipleDeprivation2015_Leicester.csv")
```
...
read_csv("~/Repos/granolarr/Data/2011_OAC_Raw_uVariables_Leicester.csv") %>%
  select(OA11CD, supgrpcode, supgrpname) %>%
  filter(supgrpcode == 6) %>%
  write_csv("~/Leicester_Suburbanites.csv")
```
