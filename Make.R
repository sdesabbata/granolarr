...
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/lectures/212_L_DataPivot.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/lectures/html"))
...
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/practicals/404_P_GeoDemographicClassification.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/practicals/pdf"))
