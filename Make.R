...
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/lectures/402_L_NeuralNetworks.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/lectures/html"))
cat("\n\n>>> Rendering 403_L_SupportVectorMachines.Rmd <<<\n\n")
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/lectures/403_L_SupportVectorMachines.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/lectures/html"))
cat("\n\n>>> Rendering 411_L_PrincipalComponents.Rmd <<<\n\n")
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/lectures/411_L_PrincipalComponents.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/lectures/html"))
cat("\n\n>>> Rendering 412_L_ClusteringCentroid.Rmd <<<\n\n")
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/lectures/412_L_ClusteringCentroid.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/lectures/html"))
cat("\n\n>>> Rendering 413_L_ClusteringHierarchicalDensity.Rmd <<<\n\n")
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/lectures/413_L_ClusteringHierarchicalDensity.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/lectures/html"))
...
cat("\n\n>>> Rendering 404_P_SupervisedLearning.Rmd <<<\n\n")
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/practicals/404_P_SupervisedLearning.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/practicals/pdf"))
cat("\n\n>>> Rendering 414_P_UnsupervisedLearning.Rmd <<<\n\n")
rmarkdown::render(paste0(Sys.getenv("GRANOLARR_HOME"), "/src/practicals/414_P_UnsupervisedLearning.Rmd"), quiet = TRUE, output_dir = paste0(Sys.getenv("GRANOLARR_HOME"), "/docs/practicals/pdf"))
